...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MaxBulletSpread_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_MaxBulletSpread;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USBTTask_RangedAttack_Statics::NewProp_MaxBulletSpread_MetaData[] = {
		{ "Category", "AI" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USBTTask_RangedAttack_Statics::NewProp_MaxBulletSpread = { "MaxBulletSpread", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USBTTask_RangedAttack, MaxBulletSpread), METADATA_PARAMS(Z_Construct_UClass_USBTTask_RangedAttack_Statics::NewProp_MaxBulletSpread_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USBTTask_RangedAttack_Statics::NewProp_MaxBulletSpread_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USBTTask_RangedAttack_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USBTTask_RangedAttack_Statics::NewProp_MaxBulletSpread,
	...
	IMPLEMENT_CLASS(USBTTask_RangedAttack, 355380782);
