...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USBTService_CheckAttackRange_Statics::NewProp_MaxAttackRange_MetaData[] = {
		{ "Category", "AI" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USBTService_CheckAttackRange_Statics::NewProp_MaxAttackRange = { "MaxAttackRange", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USBTService_CheckAttackRange, MaxAttackRange), METADATA_PARAMS(Z_Construct_UClass_USBTService_CheckAttackRange_Statics::NewProp_MaxAttackRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USBTService_CheckAttackRange_Statics::NewProp_MaxAttackRange_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USBTService_CheckAttackRange_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USBTService_CheckAttackRange_Statics::NewProp_MaxAttackRange,
	};
	...
	IMPLEMENT_CLASS(USBTService_CheckAttackRange, 2526779058);
